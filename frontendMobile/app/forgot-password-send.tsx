...
export default function ForgotPasswordSendScreen() {
    ...
    return (
        <View style={{ flex: 1 }}>
            <LinearGradient colors={[theme.COLORS.primary, theme.COLORS.secondary]} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} style={[theme.CONTAINER_STYLES.center, { paddingVertical: 125, paddingHorizontal: 30 }]} >
                <View style={[{ backgroundColor: theme.COLORS.background, borderRadius: 18, paddingHorizontal: theme.SPACING.large, paddingVertical: theme.SPACING.xLarge, width: '85%' }]}>
                    ...
                    <View style={{ marginBottom: theme.SPACING.medium }}>
                        ...
                        <View style={theme.INPUT_STYLES.container}>
                            ...
                            <TextInput style={[theme.INPUT_STYLES.text, { paddingVertical: theme.SPACING.small }]} placeholder={texts.securityCodePlaceholder} placeholderTextColor={theme.COLORS.placeholder} keyboardType="default" />
                        </View>
                    </View>
                    ...
                    <View style={{ marginBottom: theme.SPACING.medium }}>
                        ...
                        <View style={theme.INPUT_STYLES.container}>
                            <SvgUri uri={getIconUri("lock.svg")} width={20} height={20} style={{ marginRight: theme.SPACING.small }} color={theme.COLORS.placeholder} />
                            <TextInput style={[theme.INPUT_STYLES.text, { paddingVertical: theme.SPACING.small }]} placeholder={texts.passwordPlaceholder} placeholderTextColor={theme.COLORS.placeholder} secureTextEntry />
                        </View>
                    </View>
